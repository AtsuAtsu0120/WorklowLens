...
```bash
pip install tool-logger-client
```
...
# クライアント作成
logger = ToolLogger("my_tool", tool_version="1.0.0")
...
```python
from tool_logger_client import ToolLogger, USAGE

logger = ToolLogger("my_tool")
