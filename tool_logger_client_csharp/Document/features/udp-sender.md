...
updated: 2026-04-04
related_files:
  - src/ToolLoggerClient/ToolLogger.cs
  - src/ToolLoggerClient/LogMessage.cs
  - src/ToolLoggerClient/EventType.cs
---
...
tool_logger_middlewareへUDPデータグラムでJSONログメッセージを送信する機能。
